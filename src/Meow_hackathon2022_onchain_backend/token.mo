...
actor Dip20Token {
	...
	stable var name_ : Text = "Cattus";
	
	stable var totalSupply_ : Nat = 10000000000;
	
	stable var symbol_ : Text = "CTS";
	
	stable var fee_ : Nat = 1000;
	
	stable var owner_ : Principal = Principal.fromText("umjcv-bwcvj-5rbec-75wba-gjn6f-xbmux-ioeo2-docpe-4gk7v-serqx-uae");
